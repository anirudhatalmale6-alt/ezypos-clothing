                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <?php }} if(isset($_SESSION['privexpense_cat'])){if($_SESSION['privexpense_cat'] == 1){  ?>
                                    <li class="has-submenu"><a href="#">Expense Category</a>
                                            <ul class="submenu open">
                                                <li><a class="has-submenu" href="<?php echo base_url('add-expense-category')?>"><span> Add </span> </a></li>
                                            </ul>
                                    </li> 
                                    <?php }} ?>                             
                                </ul>
                            ...
                            if(retrnQty>0&&retrnAmount>0){
                                ...
                                var rItmname=$("#supReturnTable").find("tr").eq(i).find("td").eq(2).text();
                                    ...
                                    $.ajax({
                                        ...
                                        data: {grnID:grnid_R,itmid:curQtyWithGrnrItmID,qty:retrnQty},
                                        async: false,
                                        dataType: "json",
                                        success: function (res) {
                                            if(res){
