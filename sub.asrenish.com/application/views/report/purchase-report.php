    ...
    $( function() {
       ...
       // $( "#saleBtn" ).click(function() {
        function load_purchase(){
            $.ajax({
                type: 'post',
                url:'<?php echo base_url()?>Reports/getPurchaseReport',
                async:false,
                dataType:'json',
       ...
       $( "#reset" ).click(function() {
        ...
        $(".datepic").datepicker({
            onSelect: function(dateText){
                ...
                var load_url='<?php echo base_url()?>Reports/getPurchaseReport_by_dates';
        ...
        $('#month_select').change(function(){
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url()?>Reports/getPurchaseReport_by_month',
