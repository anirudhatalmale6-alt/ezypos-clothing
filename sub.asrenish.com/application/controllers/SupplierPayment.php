...
class SupplierPayment extends CI_Controller {
    ...
    public function adjustCashCredit(){
       ...
       // $result = $this->SupPayment_model->adjust_supllier_CashCredit();
        echo json_encode($result);
    }
    ...
    public function supplier_nongrn_balance_update(){
        $result = $this->SupPayment_model->supplier_nongrn_balance_update();
        echo json_encode($result);
    }
    ...
    public function SupplierOutstanding_by_supplier(){
        $supid=$this->input->post('sup_ID');
        $result = $this->Payment_model->supplier_for_payment($supid);
        echo json_encode($result);
    }
